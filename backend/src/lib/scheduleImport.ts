...
- type: "RACE" für alles, was auf der Bahn stattfindet — also Wettkämpfe UND Rahmenprogramm-/Vorführungspunkte, die die Bahn belegen (z.B. "Stehende Runde", Show-/Demorennen, Rekordversuche). "CEREMONY" für Siegerehrungen. "INFO" AUSSCHLIESSLICH für Zeiten, in denen nichts auf der Bahn stattfindet: Warm-up, Bahn-Öffnung/-Schließung, Pausen, Ende-/Hinweiszeilen. Faustregel: Findet zur genannten Uhrzeit etwas auf der Bahn statt, ist es "RACE" (nicht "INFO"), auch wenn es als "Rahmenprogramm" o.ä. gekennzeichnet ist.
